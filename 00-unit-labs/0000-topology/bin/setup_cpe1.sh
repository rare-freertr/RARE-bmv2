...
ip link add $FREERTR_ETH0 type veth peer name p4-core1-dp1
...
ip netns exec $FREERTR_HOSTNAME $FREERTR_HOME/bin/freertr.sh -i "$FREERTR_ETH0/22705/22706" -r "$FREERTR_HOSTNAME" 
